...
export default {
	...
	'showcase.autoHint': 'Automatic: your rarest badges',
	'showcase.choose': 'Choose my showcase',
	'showcase.intro': 'Pick up to {max} badges, in the order to show them.',
	'showcase.picked': { one: '{n} badge chosen out of {max}', other: '{n} badges chosen out of {max}' },
	'showcase.limit': '{max} badges at most',
	'showcase.place': 'Place {n} in the showcase.',
	'showcase.save': 'Save',
	'showcase.cancel': 'Cancel',
	'showcase.automatic': 'Back to automatic',
	'showcase.saving': 'Saving…',
	'showcase.error.forbidden': "Only this profile's owner can choose its showcase",
	'showcase.error.invalid': 'This selection was refused: reload the page and try again',
	'showcase.error.failed': 'The change failed: try again later',
	...
	'badge.master.name': 'Master',
	'badge.master.rule': "Win a discipline every time it is held, twice or more: the title is lost the first time you don't win it",
	...
	'badge.decathlete.rule': 'Reach the podium in 10 different disciplines, in editions of 4 teams or more',
	...
	'badge.metronome.rule': 'Reach the podium in every discipline (4 or more) of an edition of 4 teams or more',
	...
	'disciplines.allTime': 'All time',
	'disciplines.allTimeIntro': 'Every discipline ever held, each with its all-time player table.',
	'disciplines.allTimeOf': '{name}, all time',
	'disciplines.editions': { one: '{n} edition', other: '{n} editions' },
	...
	'discipline.tabs': 'Discipline sections',
	...
	'claim.copy': 'Copy',
	'claim.copyUsername': 'Copy the username',
	'claim.copied': 'Username copied',
	'claim.copyFailed': 'Could not copy: the username is selected',
	'claim.password': 'Password',
	'claim.confirmation': 'Confirm the password',
	'claim.submit': 'Activate my account',
	'claim.invalidLink': 'This link is no longer valid: ask an organiser for a new one',
	...
	'claim.error.password_too_similar': 'Password too close to your name, username or email',
	'claim.error.invalid': 'Password refused: choose another one',
	'claim.error.failed': 'Activation failed: try again later',
	'photo.change': 'Change my photo',
	'photo.title': 'My photo',
	'photo.public': 'Your photo will be publicly visible on the site.',
	'photo.choose': 'Choose a photo',
	'photo.crop': 'Photo framing',
	'photo.cropHelp': 'Drag the photo to frame it, or use the arrow keys; + and − to zoom.',
	'photo.zoom': 'Zoom',
	'photo.save': 'Save',
	'photo.cancel': 'Cancel',
	'photo.close': 'Close',
	'photo.remove': 'Delete my photo',
	'photo.saving': 'Saving…',
	'photo.removing': 'Deleting…',
	'photo.locked': 'Photo uploads have been turned off by an organiser',
	'photo.error.missing': 'Choose a photo first',
	'photo.error.too_large': 'Photo too heavy: try another one',
	'photo.error.bad_format': 'Unsupported format: JPEG, PNG or WebP',
	'photo.error.too_many_pixels': 'Image too large: try another one',
	'photo.error.photo_locked': 'Photo uploads have been turned off by an organiser',
	'photo.error.throttled': 'Too many photos sent: try again later',
	'photo.error.forbidden': "Only this profile's owner can change its photo",
	'photo.error.unreadable': 'This image cannot be read: try another one',
	'photo.error.failed': 'The change failed: try again later',
	'orga.pill': 'Orga',
	'orga.logout': 'Log out',
