...
class Volleyball(Discipline):
    """
    Volleyball is a discipline that takes place in an edition of the Olympic Warriors.
    ...
    def save(self, *args, **kwargs):
        """
        Override save method to set discipline name to volleyball, schedule games and initialize team results.
        """
